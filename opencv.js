        ...
        var cv = (() => {
            ...
            return (
                function(moduleArg = {}) {
                    ...
                    var _malloc = Module["_malloc"] = wasmExports["aa"];
                    var _free = Module["_free"] = wasmExports["ca"];
                    var __emscripten_stack_restore = wasmExports["da"];
                    var __emscripten_stack_alloc = wasmExports["ea"];
                    var _emscripten_stack_get_current = wasmExports["fa"];
                    var ___cxa_demangle = wasmExports["ga"];
                    var ___cxa_is_pointer_type = wasmExports["ha"];
                    var dynCall_ji = Module["dynCall_ji"] = wasmExports["ia"];
                    var dynCall_viijii = Module["dynCall_viijii"] = wasmExports["ja"];
                    var dynCall_jiii = Module["dynCall_jiii"] = wasmExports["ka"];
                    var dynCall_vij = Module["dynCall_vij"] = wasmExports["la"];
                    var dynCall_jii = Module["dynCall_jii"] = wasmExports["ma"];
                    var dynCall_viji = Module["dynCall_viji"] = wasmExports["na"];
                    var dynCall_jiji = Module["dynCall_jiji"] = wasmExports["oa"];
                    var dynCall_iiiiij = Module["dynCall_iiiiij"] = wasmExports["pa"];
                    var dynCall_iiiiijj = Module["dynCall_iiiiijj"] = wasmExports["qa"];
                    var dynCall_iiiiiijj = Module["dynCall_iiiiiijj"] = wasmExports["ra"];
